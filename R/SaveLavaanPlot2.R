...
#'
#' @name saveLavaanPlot2
#' @title Save Lavaan Plot 2
#' @docType package
...
#' @examples
#' \dontrun{
#' Save_LavaanPlot2(fit = SEMModel1,
...
#' }
#'
# Function to fit the SEM model, and save it
...
#'
#'
saveLavaanPlot2 <- function(fit, filePath, coefs = TRUE, stand = TRUE, sig = 0.05,
